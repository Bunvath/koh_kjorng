...
function(d) {
    ...
    _fixed_menu = function() {
        var t = document.getElementById("top-bar"),
            e = d(t),
            i = e.next("header").innerHeight() - 200,
            n = !1;
        window.onscroll = function() {
            (window.pageYOffset || document.documentElement.scrollTop) >= i ? n || (e.off(o).addClass("fixed in").one(o, function(t) {
                d(t).removeClass("in")
            }), n = !n) : n && (d(t).removeClass("in").addClass("out").removeClass("fixed out").off(o).one(o, function(t) {
                d(t).removeClass("fixed out")
            }), n = !n)
        }
            ...
            jQuery(document).ready(function($){
                ...
                var slider = $('#vegas-slider'),
                    slides = [
                        {
                            name: "img 1",
                            src: './asset/img/home_img/img_1.jpg'
                        },
                        {
                            name: "img 2",
                            src: './asset/img/home_img/img_2.jpg'
                        },
                        {
                            name: "img 3",
                            src: './asset/img/home_img/img_3.jpg'
                        }
                    ],
